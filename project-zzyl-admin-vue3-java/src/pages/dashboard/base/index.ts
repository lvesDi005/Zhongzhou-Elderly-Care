...
// 老人等级分布
export function getElderRankDistribution(data){
  return {
...
// 老人年龄分布
export function getElderAgeDistribution (data){
  let xAxisData = ['60岁以下','60-70岁','71-80岁','81-90岁','90岁以上'];
  return  {
    color:['#27C2AE','#FE6E6E'],
    legend: {
      data: ['男', '女', ],
